...
#include <iostream>
#include "utils.h"
void christofied::read_answer_file() {
...
void christofied::read_tsp_file() {
...
void myalgorithm::read_tsp_file() {
    std::string filename = "tsp/"+this->file_name + ".tsp";
    std::ifstream infile(filename);
    std::string line;
...
void myalgorithm::read_answer_file() {
    std::string filename = "tsp/"+this->file_name + ".opt.tour";
    std::ifstream infile(filename);
    std::string line;
...
void heldkarp::read_answer_file() {
    std::string filename = "tsp/"+this->file_name + ".opt.tour";
    std::ifstream infile(filename);
    std::string line;
